...
public class BoardServiceImpl implements BoardService {
    ...
    @Autowired
    public BoardServiceImpl(BoardMapper boardMapper, BoardRepository boardRepository, ColumnListRepository columnListRepository, CardRepository cardRepository) {
